...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("ExclusiveCoin-ext-ip");
...
void ThreadSocketHandler(void* parg)
{
    ...
    RenameThread("ExclusiveCoin-net");
...
void ThreadMapPort(void* parg)
{
    ...
    RenameThread("ExclusiveCoin-UPnP");
...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "ExclusiveCoin " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
void ThreadDNSAddressSeed(void* parg)
{
    ...
    RenameThread("ExclusiveCoin-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("ExclusiveCoin-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("ExclusiveCoin-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("ExclusiveCoin-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. ExclusiveCoin is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    RenameThread("ExclusiveCoin-start");
