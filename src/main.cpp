...
const string strMessageMagic = "ExclusiveCoin Signed Message:\n";
...
const int DAILY_BLOCKCOUNT =  2160;
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "ExclusiveCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Thu, 18 Sep 2014 21:03:47 GMT";
        CTransaction txNew;
        txNew.nTime = 1411074229;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1411074229;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 1262459;
		if(fTestNet)
        {
            block.nNonce   = 1262459;
        }
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0x000b79f85685245992bcce6861285982f370180f4d7b4b8f6daf4b0408f9affc"));
        block.print();
